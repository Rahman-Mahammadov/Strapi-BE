...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    quantitySold: Attribute.Integer;
    rating: Attribute.Decimal;
    isWishlisted: Attribute.Boolean & Attribute.DefaultTo<false>;
    variations: Attribute.Relation<
      'api::product.product',
      'manyToMany',
      'api::variation.variation'
    >;
    marka: Attribute.String;
    inBox: Attribute.Blocks;
    product_details: Attribute.Blocks;
    sameDayDelivery: Attribute.Boolean & Attribute.DefaultTo<false>;
    ...
    >;
    user_orders: Attribute.Relation<
      'api::product.product',
      'manyToMany',
